...
namespace GenshinWishCounter1._5.Service
{
    public class DatabaseService : IDatabaseService
    {
        ...
        private readonly List<FiveStarModel> GenshinCharacterList =
            [
            new FiveStarModel{ Name = "Lauma", Type = CategoryStrings.Dendro, IsStandard =  false },
        ...
        [
            new FiveStarModel{ Name = "Nightweaver's Looking Glass", Type = CategoryStrings.Catalyst, IsStandard = false},
        ...
        [
            new FiveStarModel{ Name = "Evernight", Type = CategoryStrings.Ice, IsStandard = false },
            new FiveStarModel{ Name = "Cerydra", Type = CategoryStrings.Wind, IsStandard = false },
        ...
        [
            new FiveStarModel { Name = "To Evernight's Stars", Type = CategoryStrings.Remembrance, IsStandard = false },
            new FiveStarModel { Name = "Epoch Etched in Golden Blood", Type = CategoryStrings.Harmony, IsStandard = false },
        ...
        [
            ...
            new FiveStarModel { Name = "Ju Fufu", Type = CategoryStrings.ZzzFire, IsStandard = false },
        ...
        [
            ...
            new FiveStarModel { Name = "Roaring Fur-nace", Type = CategoryStrings.ZzzStun, IsStandard = false },
        ...
        public List<FiveStarModel> GetFiveStarList(Banner banner)
        {
            switch (banner)
            {
                case Banner.GenshinCharacter: return [.. GenshinCharacterList.OrderBy(x => x.Name)];
                case Banner.StarRailCharacter: return [.. StarRailCharacterList.OrderBy(x => x.Name)];
                case Banner.GenshinWeapon: return [.. GenshinWeaponList.OrderBy(x => x.Name)];
                case Banner.StarRailWeapon: return [.. StarRailWeaponList.OrderBy(x => x.Name)];
                case Banner.ZzzCharacter: return [.. ZzzCharacterList.OrderBy(x => x.Name)];
                case Banner.ZzzWeapon: return [.. ZzzWeaponList.OrderBy(x => x.Name)];
                default: return [];
            }
        }
    }
